	...
	$.ajax({
		...
		success: function (result) {
			...
			if (result.max) {
				...
				$(".wrap-cart").html(
					'<a href="san-pham" class="empty-cart text-decoration-none d-block text-center"><i class="fa-duotone fa-cart-xmark"></i><p>' +
						LANG["no_products_in_cart"] +
						'</p><span class="btn btn-warning">Tiếp tục mua hàng</span></a>'
				);
			}
			holdonClose();
		},
...
function loadDistrict(id = 0) {
	holdonOpen();
	fetch(CONFIG_BASE + `assets/jsons/district-` + id + `.json`, {
